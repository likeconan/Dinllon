...
@connect((store) => {
    return {
        ...
        friendEmail: store.activity.friendEmail,
    }
})
class JoinActivityDialog extends Component {
    ...
    editFriendEmail = (e) => {
        this.props.dispatch(editFriendEmail(e.target.value));
    }
    render() {
        ...
        return (
            <ResponsiveDialog modal={false} open={this.props.open} title='Join In Activity'
                ...
                <div className='margin-bottom'>
                    <FormTextField floatingLabelText="Your friend's email" validated={this.props.validatedJoin}
                        onChange={this.editFriendEmail} value={this.props.friendEmail}
